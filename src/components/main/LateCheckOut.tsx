const LateCheckOut = () => {
  return (
    <section>
      <button className="relative max-w-xs w-full overflow-hidden rounded-2xl flex flex-col items-start p-5 cursor-pointer">
        <div className="absolute inset-0 bg-[url(/bg/background-1.jpg)] bg-no-repeat bg-center bg-cover" />
        <div className="absolute inset-0 bg-black/55" />
        <div className="relative z-10 flex flex-col w-full items-start">
          <div className="bg-[#ffffff21] rounded-full p-1.5 flex items-center justify-center self-end mb-2">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"

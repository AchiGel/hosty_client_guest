...
const SubcategoryCard = ({
  ...
  return (
    <button
      onClick={onClick}
      className="group p-4 rounded-2xl bg-white border border-neutral-100 shadow-[0_1px_3px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300 text-left"
    >
